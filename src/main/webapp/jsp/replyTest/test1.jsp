...
<div class="container">
	...
	<h5>입력 테스트</h5>
	<button id="btn1">TEST CREATE - succcess </button>
	...
	<h5>댓글 수정 FORM</h5>
	<input id = "input1" name="rno" value="23" readonly="readonly"> <br>
	<input id = "input2" name="bno" value="89" readonly="readonly"> <br>
